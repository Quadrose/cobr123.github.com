...
Пригород            '+ (nvl(parseFloat(val['ar']), 1) / 1000 * 0.44).toFixed(2) +'';
				...
				output += '<td '+getColStyle('area_rent')+' align="right" id="td_area_rent" title="'+ area_rent_title +'" data-value="'+ unknownIfNull(locale, parseFloat(val['ar']) / 1000) +'">'+unknownIfNull(locale, parseFloat(val['ar']) / 1000)+'</td>';
				...
				if(val['rbs'] != null){
					...
					if(retailBySpec != null){
						$('#equip_raw_mat_body > tr:eq(0) > td:eq(2) > a > img').each(function() {
							...
							output += '<td '+getColStyle('rbs_lpr')+' align="right" id="td_rbs_lpr_' + rbsKey + '" data-value="'+parseFloat(retailBySpec[rbsKey].lpr).toFixed(2)+'"><a target="_blank" href="https://' + domain + '/' + realm + '/main/globalreport/marketing/by_trade_at_cities/' + rbsKey + '/' + val.ci + '/' + val.ri + '/' + val.ti + '">' + commaSeparateNumber(parseFloat(retailBySpec[rbsKey].lpr).toFixed(2)) + '</a></td>';
							output += '<td '+getColStyle('rbs_lq')+' align="right" id="td_rbs_lq_' + rbsKey + '" data-value="'+parseFloat(retailBySpec[rbsKey].lq).toFixed(2)+'"><a target="_blank" href="https://' + domain + '/' + realm + '/main/globalreport/marketing/by_trade_at_cities/' + rbsKey + '/' + val.ci + '/' + val.ri + '/' + val.ti + '">' + commaSeparateNumber(parseFloat(retailBySpec[rbsKey].lq).toFixed(2)) + '</a></td>';
							output += '<td '+getColStyle('rbs_spr')+' align="right" id="td_rbs_spr_' + rbsKey + '" data-value="'+parseFloat(retailBySpec[rbsKey].spr).toFixed(2)+'"><a target="_blank" href="https://' + domain + '/' + realm + '/main/globalreport/marketing/by_trade_at_cities/' + rbsKey + '/' + val.ci + '/' + val.ri + '/' + val.ti + '">' + commaSeparateNumber(parseFloat(retailBySpec[rbsKey].spr).toFixed(2)) + '</a></td>';
							output += '<td '+getColStyle('rbs_sq')+' align="right" id="td_rbs_sq_' + rbsKey + '" data-value="'+parseFloat(retailBySpec[rbsKey].sq).toFixed(2)+'"><a target="_blank" href="https://' + domain + '/' + realm + '/main/globalreport/marketing/by_trade_at_cities/' + rbsKey + '/' + val.ci + '/' + val.ri + '/' + val.ti + '">' + commaSeparateNumber(parseFloat(retailBySpec[rbsKey].sq).toFixed(2)) + '</a></td>';
						});
					}
				}
				output += '</tr>';
